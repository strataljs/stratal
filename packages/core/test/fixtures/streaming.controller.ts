...
export class StreamingController {
  @Get('/stream', { response: { schema: any(), contentType: 'application/octet-stream' } })
  ...
  @Get('/stream-error', { response: { schema: any(), contentType: 'application/octet-stream' } })
  ...
  @Get('/text', { response: { schema: any(), contentType: 'text/plain' } })
  ...
  @Get('/sse', { response: { schema: any(), contentType: 'text/event-stream' } })
